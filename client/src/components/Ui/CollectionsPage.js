        ...
        {type === "homepage" &&
            ...
            <div className=" w-[95%] md:w-[50%]">   
                <div className="relative">
                    ...
                    <input onKeyUp={handleKeyDown} onChange={(e) => setsearch(e.target.value)} type="search" className="block w-full p-4 pl-10 text-sm text-white input" placeholder="Search Collections" required />
                </div>
            </div>
